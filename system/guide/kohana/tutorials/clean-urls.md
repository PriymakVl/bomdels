...
The rest of the `.htaccess file` rewrites all requests through index.php, unless the file exists on the server (so your css, drawings, favicon, etc. are still loaded like normal).  In most cases, you are done!
